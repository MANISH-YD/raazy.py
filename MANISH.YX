...
def back():
	login()
def contact():
	os.system('xdg-open https://www.facebook.com/manishexeee')
	back()
def linex():
	print("""\x1b[37m----------------------------------------------""")
def cls():
...
| $$\  $ | $$| $$  | $$| $$\  $$$  | $$   /$$  \ $$| $$  | $$
| $$ \/  | $$| $$  | $$| $$ \  $$ /$$$$$$|  $$$$$$/| $$  | $$
|__/     |__/|__/  |__/|__/  \__/|______/ \______/ |__/  |__/ \x1b[38;5;196m1.1\x1b[37m
          """)
def info():
	print(f"""\x1b[37m----------------------------------------------
 AUTHOR     : MANISH YADAV
 GITHUB     : kingkai.github.com
...
def menu(my_name,my_id):
	...
	linex()
	_____manishyyy_____ = input(' CHOOSE : ')
	if _____manishyyy_____ in ['1']:
		manish_public()
	elif _____manishyyy_____ in ['2']:
		fileopt()
	elif _____manishyyy_____ in ['3','03']:
		passask()
		manishresults()
	elif _____manishyyy_____ in ['4','04']:
		passask()
		...
		restart()
	elif _____manishyyy_____ in ['5','05']:
		contact()
	elif _____manishyyy_____ in ['0']:
		passask()
...
def manishresults():
    ok_file_path = '/sdcard/MANISHv6/MANISHv6-OK.txt'
    cp_file_path = '/sdcard/MANISHv6/MANISHv6-CP.txt'
...
def contact():
	os.system('xdg-open https://www.facebook.com/aar.av.9678067')
#-------------------[ GROUPS ]----------------#
